        ...
        private bool GetCommand()
        {
            ...
            switch(keyPressed)
            {
                ...
                case ConsoleKey.D2:
                    ...
                    var didItWork = GarageHandler.AddVehicle(input);

                    //if(didItWork )
                    //{
                    //    Console.WriteLine($"Vehicle with license {input} succesfully added to garage.");
                    //}
                    //else
                    //{
                    //    Console.WriteLine($"Vehicle with license {input} was not added to garage.");
                    //}
